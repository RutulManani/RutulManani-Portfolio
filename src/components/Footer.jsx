    ...
    <footer>
      <div className="footer-content">
        ...
        <div className="social-links">
          <a href="https://www.linkedin.com/in/rutulmanani/" className="social-link"><i className="fab fa-linkedin-in"></i></a>
          <a href="https://www.behance.net/rutulmanandb9b" className="social-link"><i className="fab fa-behance"></i></a>
          <a href="https://github.com/RutulManani" className="social-link"><i className="fab fa-github"></i></a>
        </div>
        <p className="copyright">© {new Date().getFullYear()} Rutul Manani. All rights reserved.</p>
      </div>
    </footer>
  );
};
